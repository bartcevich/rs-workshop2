...
const jsonText=[
  ...
  {"type": "001",
    "name": "Мороженое 'ЮККИ' пломбир шоколадный на сливках, 75 г",
    "img": "./images/YUKKI_plombir na slivkah_500.png",
    "breed": "Цена за 1 кг : 23, 47 р",
    "description": "Состав: вола, молоко сгущеное с сахаром, вафельный стаканчик( мука, подсолнечное масло, картофельный крахмал, соль, вода, разрыхлитель), сахар, какао-порошок, сливки, сухое молоко, патока, эмульгатор, стабилизатор.",
    "age": "Масса - 500 г",
    "inoculations": ["Характеристики Пищевая ценность на 100 г Белки2.8 Жиры8 Углеводы21.5 Энергетическая ценность169 ккал/709 кДж"],
    "diseases": ["Условия и сроки хранения хранить при t не выше - 18°С. Срок годности 12 месяцев. Дата изготовления указана на упаковке. "],
    "parasites": ["none"]
  },
  { "name": "Timmy",
...
function addText() {
  jsonText.forEach(obj => {
    if(obj.type === Name){
      ...
      text4 = `<p id="pop_text4"><b>Масса: </b>${obj.age}</p>`;
      text3 = `<p id="pop_text3">${obj.description}</p>`;
      text5 = `<p id="pop_text5">${obj.inoculations}</p>`;
      text6 = `<p id="pop_text6">${obj.diseases}</p>`;
...
const Katrine_pop = document.getElementById('001');
